...
const { shuffle, replaceLetter, container, randomNT, union } = require('../utils');
...
function removeLeftRecursion(grammer = new Grammer("")) {
  ...
  nonTerminator.forEach((n, i) => {
    ...
    const newProductions = removeDirectLeftRecursion(finalProduction, union([...grammer.getNonTerminator()], Object.keys(productionsKeeper)));
